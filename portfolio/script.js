    document.addEventListener('DOMContentLoaded', () => {
        ...
        const applyTheme = (theme) => {
            ...
            if (ghChart) {
                ghChart.src = theme === 'dark' ? 'https://ghchart.rshah.org/34d399/aarav-mehta-dev' : 'https://ghchart.rshah.org/0f766e/aarav-mehta-dev';
            }
            ...
            if (window.VANTA && window.VANTA.NET) {
                ...
                window.vantaEffect = window.VANTA.NET({
                    ...
                    scale: 1.00,
                    scaleMobile: 0.85,
                    color: theme === 'dark' ? 0x34d399 : 0x0f766e,
                    backgroundColor: theme === 'dark' ? 0x020617 : 0xfffaf1,
        ...
        if (blogContainer) {
            ...
            const HASHNODE_HOST = 'aaravmehta.hashnode.dev'; // your blog subdomain
    ...
    // showMessageBox moved up before applyTheme
        ...
        const executeCommand = async (cmd) => {
            ...
            switch (command) {
                ...
                case 'socials':
                    const socialsText = `
                        ...
                        <div class="mt-2" style="line-height: 1.8;">
                            <div>
                                <a href="https://github.com/aarav-mehta-dev" target="_blank" rel="noopener noreferrer" class="terminal-help-command underline">GitHub</a>
                                <span class="terminal-help-description"> - github.com/aarav-mehta-dev</span>
                            </div>
                            <div>
                                <a href="https://www.linkedin.com/in/aarav-mehta-dev" target="_blank" rel="noopener noreferrer" class="terminal-help-command underline">LinkedIn</a>
                                <span class="terminal-help-description"> - linkedin.com/in/aarav-mehta-dev</span>
                            </div>
                        </div>
                    `;
                ...
                case 'skills':
                    ...
                    break;
                case 'contact': printToTerminal(`You can reach me at: <a href="mailto:aarav.mehta.dev@example.com" class="text-link underline">aarav.mehta.dev@example.com</a>`); break;
                case 'theme':
                    // --- Check if Matrix Mode is active ---
                    if (docElement.classList.contains('matrix-mode')) {
                ...
                case 'repo':
                    ...
                    window.open("https://github.com/aarav-mehta-dev/Portfolio_Website", "_blank");
                    break;
        ...
        const showWelcomeMessage = () => {
            const welcome = `*********************************************************
    * Welcome to Aarav Mehta's Interactive Portfolio!   *
    *********************************************************
